...
const page_url = urljoin(GATSBY_APP_URL, '/solution-retail')
    ...
    axios
      ...
      .then(res => {
        ...
        if (
          ...
          document.getElementsByClassName('solutionRetailLoader')[0].remove()
        }
        ...
        <Layout>
          ...
          <main>
            <Banner
              ...
              image={this.state.page_data.field_banner[0].url}
            />
            <div className="solution-retail solutionRetailContent">
              <div className="simpleContent ta_center secPad">
                <Container>
                  <div className="content ">
                    <SVGLoader loaderClass="solutionRetailLoader" />
                    <div
              ...
              <div className="customerSec secPad litBg solutionRetailContent">
                <Container>
                  <div
              ...
              <div className="customerSec secPad spiceSec solutionRetailContent">
                <Container>
                  <div
