...
import sideThumb_1 from '../../assets/images/open-api/global.jpg'
import sideThumb_2 from '../../assets/images/open-api/dynamic.jpg'
import sideThumb_3 from '../../assets/images/open-api/flexible.jpg'
import SideBySide from '../../components/sideBySide'
import imageBanner from '../../assets/images/open-api/API_Header.jpg'
...
const page_url = urljoin(GATSBY_APP_URL, '/platform/open-api')
...
class App extends Component {
  state = {
    page_data: {
      ...
      field_two_columns_description: null,
      field_two_columns_title_descript: null,
    },
  }
    ...
    axios
      ...
      .then(res => {
        ...
        if (
          ...
          document.getElementsByClassName('openAPILoader')[0].remove()
        }
        ...
        if (
          ...
          const field_two_columns_description = page_data.field_two_columns_description[0].processed.replace(
            /src="\//g,
            `src="${CMS_URL}/`
          )
          this.setState({ field_two_columns_description })
        }
        ...
        if (
          ...
          const field_two_columns_title_descript = page_data.field_two_columns_title_descript[0].processed.replace(
            /src="\//g,
            `src="${CMS_URL}/`
          )
          this.setState({ field_two_columns_title_descript })
        }
      })
      .catch(error => {
            ...
            <div className="whiIpaas openApi">
              <div className="simpleContent mb-5">
                <Container>
                  <div className="content text-center">
                    <SVGLoader loaderClass="openAPILoader" />
                    <div
              ...
              <div className="sideBySide_Z whyipaasHolder">
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: this.state.field_two_columns_description,
                  }}
                />
              </div>
            </div>
