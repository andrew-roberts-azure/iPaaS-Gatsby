...
const page_url = urljoin(GATSBY_APP_URL, '/platform/platform-features')
    ...
    axios
      ...
      .then(res => {
        ...
        if (
          ...
          document.getElementsByClassName('PlatformFeaturesLoader')[0].remove()
        }
              ...
              <div className="simpleContent mb-5">
                <Container>
                  <div className="content text-center">
                    <SVGLoader loaderClass="PlatformFeaturesLoader" />
                    <div
