...
const page_url = urljoin(GATSBY_APP_URL, '/platform/integration-features')
    ...
    axios
      ...
      .then(res => {
        ...
        if (
          ...
          document
            .getElementsByClassName('IntegrationIeaturesLoader')[0]
            .remove()
        }
              ...
              <div className="simpleContent mb-5">
                <Container>
                  <div className="content text-center">
                    <SVGLoader loaderClass="IntegrationIeaturesLoader" />
                    <div
