...
import partner from '../../../assets/images/partnerOverview.jpg'
...
const page_url = urljoin(GATSBY_APP_URL, '/partners/become-a-partner')
  ...
  render() {
    ...
    return (
      <Layout>
        <SEO
          url={page_url}
          title="Partners | Become a Partner | iPaaS - Integration Platform for Connecting Small and Enterprise Applications"
          ...
          image={GATSBY_APP_URL + '' + partner}
          description="Become our partner"
        />
        <main>
          <Banner title="Become a Partner" fluid="true" image={partner} />
              ...
              <div className="container">
                <div className="small-container">
                  <div className="content">
                    ...
                    <p>
                      Fill out the form here and we’ll follow up soon with more
                      information about our partner program
                    </p>
                  </div>
