...
const page_url = urljoin(
  GATSBY_APP_URL,
  '/partners/tech-partners/partner-detail'
)
    ...
    return (
      <>
        <Layout>
          <SEO
            url={page_url}
            title="Partners | Tech Partners | Partner Detail | iPaaS - Integration Platform for Connecting Small and Enterprise Applications"
