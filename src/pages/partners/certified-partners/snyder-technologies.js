...
const page_url = urljoin(
  GATSBY_APP_URL,
  '/partners/certified-partners/snyder-technologies'
)
  ...
  render() {
    ...
    return (
      <Layout>
        <SEO
          url={page_url}
          title="Partners | Find a certified MISP | Snyder Technologies | iPaaS - Integration Platform for Connecting Small and Enterprise Applications"
              ...
              <Row>
                <Col md="12">
                  <div className="text-center page_body_content">
                    <h2>About Snyder Technologies</h2>
                    <p>
                  ...
                  <Col lg="4" md="6">
                    <div className="colIcon">
                      ...
                      <p>
                        ...
                        directly with the iPaaS team to turn their vision into
